...
Login and Shopping
    ...
    Run Keyword If    "Password" == "True"    Log    la page contient le texte Password
    Click Element     //div[@id='login_credentials']
    ...
    # Click Element    //div[@id='login_button_container']/div/form/input
    # Log    4 : 🎉 Bravo logging correct 🎉

    # Click Element   //option[@value="za"]
    # Log    4 : 🎉 Bravo le trie descendant a été réalisé 🎉
    ...
    # \    ${element}    Get Element    //option[@value='${option}']
    ...
    # \    Run Keyword If    ${add_to_cart_button} != ${None}    Click Element    ${add_to_cart_button}
    # \    Log    4 : ${item_id.capitalize().replace('-', ' ')} : ajouté au panier
    # \    Sleep    ${DELAY}
    # \    Run Keyword If    ${add_to_cart_button} != ${None}    ${count} +=    1
    # \    Run Keyword Unless    ${add_to_cart_button} != ${None}    Log    4 : Erreur lors de l'ajout de l'élément ${item_id}: Element not found
    ...
    # \    Run Keyword If    ${remove_button} != ${None}    Click Element    ${remove_button}
    # \    Sleep    ${DELAY}
    # \    Log    5.1 : Supprimé du panier : ${item_name}
    # \    Run Keyword Unless    ${remove_button} != ${None}    Log    Erreur lors de la suppression de l'élément ${item_name}
    ...
    # \    Run Keyword Unless    ${imgAurevoir} != ${None}
