...
Login and Shopping
    ...
    # Cliquer sur le bouton "add-to-cart-sauce-labs-backpack"
    ...
    # Cliquer à nouveau sur le bouton "add-to-cart-sauce-labs-backpack"
    Click Element    //button[@id='add-to-cart-sauce-labs-backpack']
    ...
    FOR    ${item_id}    IN    @{item_ids}
        ${add_to_cart_button}    Click Element     //button[@id='add-to-cart-${item_id}']
        Append To List    ${add_to_cart_buttons}    ${add_to_cart_button}
    END
