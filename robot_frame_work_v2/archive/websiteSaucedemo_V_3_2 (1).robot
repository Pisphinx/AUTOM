...
Ajouter des élements dans le panier : 
    ...
    Wait Until Page Contains Element    //button[@id='add-to-cart-sauce-labs-bike-light']    timeout=50s
    Log    --- Element :'sauce-labs-bike-light' ajouté avec succès. 🙌 🙌 ---
    Click Element    //button[@id='add-to-cart-sauce-labs-bike-light'] 
    
    Wait Until Page Contains Element    //button[@id='add-to-cart-sauce-labs-fleece-jacket']    timeout=50s
    Log    --- Element :'sauce-labs-fleece-jacket' ajouté avec succès. 🙌 🙌 ---
    Click Element    //button[@id='add-to-cart-sauce-labs-fleece-jacket']


    Wait Until Page Contains Element    //button[@id='add-to-cart-sauce-labs-onesie']    timeout=50s
    Log    --- Element :'sauce-labs-onesie' ajouté avec succès. 🙌 🙌 ---
    Click Element    //button[@id='add-to-cart-sauce-labs-onesie'] 
    
    Wait Until Page Contains Element    //button[@id='add-to-cart-test.allthethings()-t-shirt-(red)']    timeout=50s
    Log    --- Element : 'add-to-cart-test.allthethings()-t-shirt-(red)' ajouté avec succès. 🙌 🙌 ---
    Click Element    //button[@id='add-to-cart-test.allthethings()-t-shirt-(red)']

Enlever des articles du panier

    Wait Until Page Contains Element    //button[@id='remove-sauce-labs-fleece-jacket']    timeout=50s
    Log    --- Element :'sauce-labs-fleece-jacket' retiré avec succès. 🙌 🙌 ---
    Click Element    //button[@id='remove-sauce-labs-fleece-jacket'] 
    
    Wait Until Page Contains Element      //button[@id='remove-to-cart-sauce-labs-backpack']    timeout=50s
    Log    --- Element 'sauce-labs-backpack :' retiré avec succès. 🙌 🙌 ---
    Click Element      //button[@id='remove-to-cart-sauce-labs-backpack'] 
