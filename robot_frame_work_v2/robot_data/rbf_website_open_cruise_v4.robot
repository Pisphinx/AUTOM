...
Création d'un compte particulier 
    ...
    Input Text  xpath=//input[@formcontrolname="username"]  Pape_d55e295c-191e-4153-ae7f-fa104b93861e@yahoo.com
...
Activation d'un compte utilisateur 
    ...
    # ${tr_element}    Wait Until Element Is Visible    xpath=//span[contains(., 'soulaimani.ouafae@yahoo.com')]    timeout=10s
    # Wait Until Element Is Enabled    xpath=//span[contains(., 'soulaimani.ouafae@yahoo.com')]    timeout=10s

    # ${approve_icon}    Get WebElement    xpath=//tr[.//span[contains(., 'soulaimani.ouafae@yahoo.com')]]//mat-icon[contains(text(), 'Approuver')]

    # Click Element    ${approve_icon}

    # Log    14 Le compte avec l'email : [soulaimani.ouafae@yahoo.com] approuvé avec succès

    # Click Element  xpath=//tr[.//span[contains(., 'pispasteven@yahoo.com')]]//mat-icon[contains(text(), 'Approuver')]
    # Log    15 Le compte avec l'email : [pispasteven@yahoo.com] approuvé avec succès
 
    # ${emailAactiver}  Wait Until Element Is Visible  xpath=//tr[.//span[contains(., 'demo@formation.ce')]]
    # Wait Until Element Is Enabled  xpath=//tr[.//span[contains(., 'demo@formation.ce')]] 
    # Log  14 L'email à activer : [demo@formation.ce] trouvé avec succès

    # ${Iapprove}  Get WebElement  xpath=//tr[.//span[contains(., 'demo@formation.ce')]]//mat-icon[contains(., 'Approuver')]   
    # Click Element  ${Iapprove}
    # Log    Le compte avec l'email : [demo@formation.ce] approuvé avec succès

    Wait Until Page Contains Element  xpath=//tr[.//span[contains(., 'Pape_d55e295c-191e-4153-ae7f-fa104b93861e@yahoo.com')]]
    ${ActEmail}  Get WebElement  xpath=//tr[.//span[contains(., 'Pape_d55e295c-191e-4153-ae7f-fa104b93861e@yahoo.com')]]
    Wait Until Element Is Visible   ${ActEmail}
    Wait Until Element Is Enabled  ${ActEmail} 
    Log    Le compte avec l'email : [Pape_d55e295c-191e-4153-ae7f-fa104b93861eyahoo.fr] trouvé et ciblé avec succès
    
    Wait Until Page Contains Element   xpath=//span[contains(., 'Pape_d55e295c-191e-4153-ae7f-fa104b93861e@yahoo.com')]/ancestor::tr//mat-icon[contains(., 'Approuver')]
    ${IcApprouver}  Get WebElement  xpath=//span[contains(., 'Pape_d55e295c-191e-4153-ae7f-fa104b93861e@yahoo.com')]/ancestor::tr//mat-icon[contains(., 'Approuver')]
    Wait Until Element Is Visible   ${IcApprouver} 
    Wait Until Element Is Enabled  ${IcApprouver}   
    Log    Le compte avec l'email : [Pape_d55e295c-191e-4153-ae7f-fa104b93861e@yahoo.com] pointé et approuvé avec succès
    Click Element  ${IcApprouver} 

    # ${ActEmail}  Get WebElement  xpath=//tr[.//span[contains(., 'Pape_83bff58c-13d3-44aa-a941-99292a6ad746@yahoo.com')]]
    # Wait Until Element Is Visible   ${ActEmail}
    # Wait Until Element Is Enabled  ${ActEmail} 
    # Log    Le compte avec l'email : [Pape_83bff58c-13d3-44aa-a941-99292a6ad746@yahoo.com] trouvé et ciblé avec succès
    # ${IcApprouver}  Get WebElement  xpath=//span[contains(., 'Pape_83bff58c-13d3-44aa-a941-99292a6ad746@yahoo.com')]/ancestor::tr//mat-icon[contains(., 'Approuver')]
    # Wait Until Element Is Visible   ${IcApprouver} 
    # Wait Until Element Is Enabled  ${IcApprouver}   
    # Log    Le compte avec l'email : [Pape_83bff58c-13d3-44aa-a941-99292a6ad746@yahoo.com] pointé et approuvé avec succès
    # Click Element  ${IcApprouver} 
Deconnexion compte ADMIN
    ${welcome}  Get WebElement  xpath=//button[@class="btn dropdown-toggle" and contains(text(),"Bienvenue ADMIN TEST")]  
    Wait Until Element Is Visible   ${welcome} 
    Wait Until Element Is Enabled  ${welcome}
