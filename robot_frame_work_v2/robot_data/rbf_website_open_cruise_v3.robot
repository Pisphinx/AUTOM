...
Activation d'un compte utilisateur 
    ...
    # ${tr_element}    Wait Until Element Is Visible    xpath=//span[contains(., 'soulaimani.ouafae@gmail.com')]    timeout=10s
    # Wait Until Element Is Enabled    xpath=//span[contains(., 'soulaimani.ouafae@gmail.com')]    timeout=10s

    # ${approve_icon}    Get WebElement    xpath=//tr[.//span[contains(., 'soulaimani.ouafae@gmail.com')]]//mat-icon[contains(text(), 'Approuver')]

    # Click Element    ${approve_icon}

    # Log    14 Le compte avec l'email : [soulaimani.ouafae@gmail.com] approuvé avec succès

    # Click Element  xpath=//tr[.//span[contains(., 'pispasteven@gmail.com')]]//mat-icon[contains(text(), 'Approuver')]
    # Log    15 Le compte avec l'email : [pispasteven@gmail.com] approuvé avec succès
 
    ${emailAactiver}  Wait Until Element Is Visible  xpath=//tr[.//span[contains(., 'demo@formation.com')]]
    Wait Until Element Is Enabled  xpath=//tr[.//span[contains(., 'demo@formation.com')]] 
    Log  14 L'email à activer : [demo@formation.com] trouvé avec succès

    ${Iapprove}  Get WebElement  xpath=//tr[.//span[contains(., 'demo@formation.com')]]//mat-icon[contains(., 'Approuver')]    timeout=10s
    Click Element  ${Iapprove}
    Log    Le compte avec l'email : [demo@formation.com] approuvé avec succès
